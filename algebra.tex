...
\cor{Langrangova identiteta}{

	1. V zgornjo formulo vstavimo $\vec{c} \times \vec{d}$ namesto $\vec{c}$.

	\[
		\left( \vec{a} \times \vec{b} \right) \times \left( \vec{c} \times \vec{d} \right) = \left(\vec{a} \cdot \left( \vec{c} \times \vec{d} \right)   \right) \cdot \vec{b} = \left( \vec{b} \cdot \left( \vec{c} \times \vec{d} \right)  \right) \cdot \vec{a}
	\]
	\[
		\implies \left( \vec{a} \times \vec{b} \right) \times \left( \vec{c} \times \vec{d} \right) = \left[  \vec{a}, \vec{c}, \vec{d}  \right] \cdot \vec{b} - \left[  \vec{b} ,\vec{c}, \vec{d}  \right] \cdot \vec{a}
	.\]

	2. S pomocjo tega izpeljemo:

	\[
		\left( \vec{a} \times \vec{b} \right) \cdot \left( \vec{c} \times \vec{d} \right) = \left[  \vec{a} , \vec{b}, \vec{c} \times \vec{d}  \right] = \vec{a} \cdot \left( \vec{b} \times \left( \vec{c} \times \vec{d} \right)  \right) = - \vec{a} \cdot \left( \left( \vec{c} \times \vec{d} \right) \times \vec{b}  \right) =
		\]
		\[- \vec{a} \cdot \left( \left( \vec{c} \cdot \vec{b} \right) \cdot \vec{d} - \left( \vec{b} \cdot \vec{d} \right) \cdot \vec{c}  \right) = \left( \vec{a} \cdot \vec{c} \right)  \cdot \left( \vec{b} \cdot \vec{d} \right) - \left( \vec{a} \cdot \vec{d} \right) \cdot \left( \vec{b} \cdot \vec{c} \right) =
		\begin{vmatrix}
...
Langrangova identiteta:

\[
	\left( \vec{a} \times \vec{b} \right) \cdot \left( \vec{c} \times \vec{d} \right) =	\begin{vmatrix}
			\vec{a} \cdot \vec{c} & \vec{a} \cdot \vec{d}\\
			\vec{b} \cdot \vec{c} & \vec{b} \cdot \vec{d}
...
Poseben primer: $\vec{c} = \vec{a}, \vec{d} = \vec{b}$:

\[
\|\vec{a} \times \vec{b}\|^{2} = \|\vec{a}\|^{2} \|\vec{b}\|^{2} - \left( \vec{a} \cdot \vec{b} \right)^{2}
\]
...
\dfn{Enacba ravnine}{
Enacba ravnine $\Sigma$ je taka enacba v spremenljivkah $(x,y,z)$, da za vsako tocko  $T(a,b,c)$ velja: ce  $T \in  \Sigma$, potem trojica $(a,b,c)$ zadosca enacbi, ce pa tocka ni element ravnine, pa ta trojica ne zadosca enacbi.
}

\dfn{Normala ravnine}{
	Normala ravnine $\Sigma$ je vsak nenicelen vektor, ki je pravokoten na  $\Sigma$. Normala ravnine ne doloci enolicno. Vzporedne ravnine imajo isto normalo. Ravnina je enolicno dolocena z normalo in eno tocko na ravnini.
}
...
\ex{}{
Doloci enacbo ravnine skozi tocke: $T_0(1,-1,3), T_1(2,0,5), T_2(-3,-1,4)$.
...
\begin{vmatrix}
	1 & 1\\
	0 & 1
\end{vmatrix} = x - 9(y+1) + 4(z-3) = x - 9y + 4z - 22
.\]

Enacba ravnine je $x - 9y = 4z - 22 = 0$.
}


\section{Razdalja do ravnine}
